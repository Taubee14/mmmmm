# -*- coding: utf-8 -*-
"""
Tests for agentscope_utils.py module.

These tests verify that the agentscope_utils.py module works correctly
with agentbricks components when AgentScope is available.
"""
...
def test_multiple_components_toolkit():
    """Test creating toolkit with multiple components."""
...
def test_multiple_components_json_schemas():
    """Test JSON schemas for multiple components."""
    import json
