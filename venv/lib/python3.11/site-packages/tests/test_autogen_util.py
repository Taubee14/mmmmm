# -*- coding: utf-8 -*-
"""
Tests for autogen_util.py module.

These tests verify that the autogen_util.py module works correctly
with agentbricks components when AutoGen is available.
"""

import pytest
from pydantic import BaseModel

from agentbricks.autogen_util import (
    AutogenToolAdapter,
