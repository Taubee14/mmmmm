...
class SearchOptions(BaseModel):
    """
    Search Options on Bailian platform for knowledge retrieval and web
    searches.
    """
...
class BailianParameters(Parameters):
    """
    Parameters for Bailian platform, extending the base Parameters with
    Bailian-specific options.
    """
    ...
    # RAG
    enable_rag: bool = False  # RAGs of bailian assistant service
    """Whether to enable Retrieval-Augmented Generation (RAG) for the
    Bailian assistant service. """
...
class BailianChatRequest(BailianParameters):
...
class BailianChatResponse(ChatCompletion):
    pass


class BailianChatCompletionChunk(ChatCompletionChunk):
    pass
