...
from agentbricks.errors import BailianError
from .agent import Role, Tool, FunctionCall
...
class OpenAIMessage(BaseModel):
    ...
    Can be a string, a list of content parts for multimodal messages, or a list
    of Bailian-specific content blocks.
    """
