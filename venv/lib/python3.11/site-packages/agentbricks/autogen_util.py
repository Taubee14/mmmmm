...
class AutogenToolAdapter(BaseTool[BaseModel, Any]):
    """Adapter class that wraps agentbricks components to make them compatible
    with AutoGen.

    This adapter allows any component that inherits from
    agentbricks.base.component.Component to be used as a tool in AutoGen agents

    Args:
        component (Component): The agentbricks component to wrap
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from agentbricks.components.searches.bailian_search import
            BailianSearch
            from agentbricks.autogen_util import ComponentToolAdapter
    ...
    def __init__(
        ...
        Args:
            component: The agentbricks component to wrap
...
def create_autogen_tools(
    ...
    components at once, similar to how langgraph_util.py provides
    LanggraphNode.

    Args:
        components: Sequence of agentbricks components to wrap
    ...
    Examples:
        Create tools from multiple components:

        .. code-block:: python

            from agentbricks.components.bailian_search import BailianSearch
            from agentbricks.components.bailian_rag import BailianRag
            from agentbricks.autogen_util import create_component_tools
            from autogen_ext.models.openai import OpenAIChatCompletionClient
            from autogen_agentchat.agents import AssistantAgent
