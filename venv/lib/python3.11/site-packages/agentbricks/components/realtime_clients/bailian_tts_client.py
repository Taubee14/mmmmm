...
from agentbricks.schemas.realtime import BailianTtsConfig
from agentbricks.components.realtime_clients.tts_client import TtsClient
...
class BailianTtsCallbacks(BaseModel):
...
class BailianTtsClient(TtsClient, ResultCallback):
    def __init__(
        self,
        config: BailianTtsConfig,
        callbacks: BailianTtsCallbacks,
    ):
