...
from agentbricks.schemas.realtime import BailianAsrConfig
from agentbricks.components.realtime_clients.realtime_component import (
    RealtimeState,
)

from agentbricks.components.realtime_clients.asr_client import AsrClient
from agentbricks.utils.logger_util import logger


class BailianAsrCallbacks(BaseModel):
...
class BailianAsrClient(AsrClient, TranslationRecognizerCallback):
    def __init__(
        self,
        config: BailianAsrConfig,
        callbacks: BailianAsrCallbacks,
    ):
