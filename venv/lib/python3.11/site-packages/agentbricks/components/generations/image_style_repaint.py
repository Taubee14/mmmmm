...
from agentbricks.utils.api_key_util import get_api_key, ApiNames
...
class ImageStyleRepaint(
    ...
    name: str = "bailian_image_style_repaint"
    description: str = (
    ...
    @trace(trace_type=TraceType.AIGC, trace_name="image_style_repaint")
    async def arun(
        self,
        args: ImageStyleRepaintInput,
        **kwargs: Any,
    ) -> ImageStyleRepaintOutput:
        """Bailian Image Style Repaint
