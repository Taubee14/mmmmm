...
from agentbricks.errors.service_errors import InputUnknownError
...
class BailianSearch(Component[SearchInput, SearchOutput]):
    """
    Search Component that calling dashscope for llm search result.
    """

    description = (
        "中文搜索可用于查询百科知识、时事新闻、天气。但它不适用于解决编程问题。"
        "它仅收录中文信息，不收录英文资料。"
    )
    name = "bailian_search_pro"

    @trace(trace_type=TraceType.SEARCH, trace_name="bailian_search")
    async def _arun(self, args: SearchInput, **kwargs: Any) -> SearchOutput:
        """Bailian Web Search component
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments including:
                ...
                - user_id: Required user ID from Bailian platform
        ...
        try:
            search_result, extra_tool_info = (
                await BailianSearch.dashscope_search_kernel(
                    url=SEARCH_URL,
                    payload=payload_string,
                    headers=header,
                    timeout=args.search_timeout,
        ...
        search_items, search_info = BailianSearch.post_process_search_detail(
        ...
        search_string = BailianSearch.post_process_search_string(
            search_input=args,
    ...
    def generate_search_payload(
        ...
        **kwargs: Any,
        ...
        messages = BailianSearch.preprocess_messages(search_input.messages)
    ...
    def post_process_search_string(
        ...
        **kwargs: Any,
        ...
        enable_source = search_options.enable_source
        query = BailianSearch.preprocess_messages(search_input.messages)[
            -1
        ].content
    ...
    def build_knowledge_for_search(
        ...
        **kwargs: Any,
        ...
        def tool_call_knowledge(_tool_output: List, **kwargs: Any) -> str:
            prompt = """以下通过权威渠道的实时信息可能有助于你回答问题，请优先参考：#以下根据实际返回选择"""  # noqa E501
...
if __name__ == "__main__":
    ...
    search_component = BailianSearch()
