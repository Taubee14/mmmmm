...
@function_tool
def agent_bay_wy_phone_run_command(command: str) -> str:
    """Run a android command and return the result.
...
@function_tool
def agent_bay_wy_phone_slide(x1: int, y1: int, x2: int, y2: int) -> str:
    """Slide from one point to another.
...
@function_tool
def agent_bay_wy_phone_type(**kwargs: dict) -> str:
    """Type a specified text using the device keyboard.
...
@function_tool
def agent_bay_wy_phone_back(action: str) -> str:
    """Perform the back navigation action.
...
@function_tool
def agent_bay_wy_phone_home(action: str) -> str:
    """Perform the home button action.
...
@function_tool
def agent_bay_wy_phone_menu(action: str) -> str:
    """Open the device menu.
...
@function_tool
def agent_bay_wy_phone_enter(action: str) -> str:
    """Simulate pressing the Enter key.
...
AGENT_BAY_WY_PHONE_GUI_TOOLS = {
    tool.function_schema.name: tool
    for tool in [
        agent_bay_wy_phone_run_command,
        agent_bay_wy_phone_click,
        agent_bay_wy_phone_slide,
        agent_bay_wy_phone_type,
        agent_bay_wy_phone_back,
        agent_bay_wy_phone_home,
        agent_bay_wy_phone_menu,
        agent_bay_wy_phone_enter,
    ]
}


@function_tool
def agent_bay_wy_computer_open_app(name: str) -> str:
    """Open a specified application on the cloud computer.
...
@function_tool
def agent_bay_wy_computer_home(action: str) -> str:
    """back desktop.
...
@function_tool
def agent_bay_wy_computer_click(x: int, y: int, count: int = 1) -> str:
    """Click on a specified position.
...
@function_tool
def agent_bay_wy_computer_right_click(x: int, y: int, count: int = 1) -> str:
    """Click on a specified position.
...
@function_tool
def agent_bay_wy_computer_click_type(x: int, y: int, text: str) -> str:
    """Click on a specified position and type the text.
...
@function_tool
def agent_bay_wy_computer_press_key(key: str) -> str:
    """Send a key or combination of keys to the system.
...
@function_tool
def agent_bay_wy_computer_append(x: int, y: int, text: str) -> str:
    """Append the content at position and press Enter.
...
AGENT_BAY_WY_COMPUTER_GUI_TOOLS = {
    tool.function_schema.name: tool
    for tool in [
        agent_bay_wy_computer_open_app,
        agent_bay_wy_computer_click,
        agent_bay_wy_computer_right_click,
        agent_bay_wy_computer_click_type,
        agent_bay_wy_computer_press_key,
        agent_bay_wy_computer_append,
        agent_bay_wy_computer_home,
    ]
}
