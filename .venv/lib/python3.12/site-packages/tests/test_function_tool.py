...
from agentbricks.base.function_tool import function_tool, tool_function_factory
from agentbricks.schemas.agent import FunctionParameters
...
async def test_tool_factory():
    ...
    assert mock_tool_cls.function_schema.parameters == FunctionParameters(
        **schema["parameters"],
    )
