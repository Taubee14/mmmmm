...
from agentbricks.base.memory import MemoryOperation
from agentbricks.components.memory.local_memory import MemoryInput
from agentbricks.components.memory.redis_memory import (
    RedisChatStore,
    RedisMemory,
)
from agentbricks.schemas.oai_llm import OpenAIMessage
...
def sample_messages():
    return [
        ...
        OpenAIMessage(role="assistant", content="Hi, how can I help you?"),
...
def test_get_messages_with_dialogue_round(
    ...
    redis_store.add_messages(run_id, sample_messages)
    messages = redis_store.get_messages(run_id, filters={"dialogue_round": 1})
...
def test_redis_memory_search(redis_memory, run_id, sample_messages):
    ...
    search_input = MemoryInput(
        ...
        run_id=run_id,
        messages=[OpenAIMessage(role="user", content="joke")],
        filters={},
    )
