...
class BaseComponent(ABC):
    ...
    def get_namespace(cls) -> list[str]:
        ...
        `agentbricks.component.internal.dashscopesearch`, then the
        namespace is ["agentbricks", "component", "dashscopesearch"]

        Returns:
            list[str]: List of namespace components derived from module path.
        """
