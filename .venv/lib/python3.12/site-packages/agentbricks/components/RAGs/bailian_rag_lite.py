...
from agentbricks.components.RAGs.bailian_rag import (
    RagInput,
    RagOutput,
    BailianRag,
)
...
class BailianRagLite(Component[RagInput, RagOutput]):
    """
    ...
    name: str = "bailian_RAG_lite"

    @trace(trace_type=TraceType.RAG, trace_name="bailian_rag_lite")
    ...
    async def retrieve_one_index(
        ...
        **kwargs: Any,
        ...
        if not pipeline_id and index_name:
            pipeline_id = await BailianRag.get_pipeline_id(
                api_key,
                base_url,
                index_name,
            )
        ...
        payload, headers = await BailianRagLite.generate_rag_request(
            args,
            **kwargs,
        )
        ...
        try:
            ...
            raise Exception(f"retrieve pipeline exceptionally: {str(e)}")
    ...
    async def generate_rag_request(
        ...
        **kwargs: Any,
        ...
        async def _build_body(_rag_input: RagInput) -> dict:
            ...
            """
            data = await BailianRag.get_body(_rag_input)
            return data
