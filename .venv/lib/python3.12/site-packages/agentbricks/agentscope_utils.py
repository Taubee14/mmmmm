...
def agentscope_tool_adapter(
    ...
    """Convert an agentbricks component to an AgentScope tool.

    This function wraps agentbricks components to make them compatible
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            BailianSearch
            from agentbricks.agentscope_utils import
...
def agentscope_toolkit_adapter(
    ...
    """Create an AgentScope toolkit from multiple agentbricks components.

    This is a convenience function that creates a toolkit with multiple
    components converted to AgentScope tools.

    Args:
        components: Sequence of agentbricks components to convert
    ...
    Returns:
        Toolkit: AgentScope toolkit with all components as tools

    Examples:
        Create toolkit from multiple components:

        .. code-block:: python

            from agentbricks.components.searches.bailian_search import
            BailianSearch
            from agentbricks.components.RAGs.bailian_rag import BailianRag
            from agentbricks.agentscope_utils import create_component_toolkit
