...
from agentbricks.mcp_utils.server import MCPServer
from agentbricks.models.llm import BaseLLM
from agentbricks.schemas.agent import (
    Message,
    Role,
    Tool,
    FunctionCall,
...
from agentbricks.utils.message_util import merge_incremental_chunk
...
@trace(trace_type=TraceType.FUNCTION_CALL, trace_name="react_loop_with_openai")
async def react_loop_with_openai(
    model: str,
    model_cls: BaseLLM,
...
# @trace("react_loop_with_agent_api")
async def react_loop_with_agent_api(
    model: str,
    model_cls: BaseLLM,
